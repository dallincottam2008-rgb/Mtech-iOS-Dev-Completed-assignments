...
//print("The value of foo is \(foo)")
print("Because the foo is in a local scope and cant be use outside of the for loop")
...
print("x outside of the for loop in 10 so it would just print 10 and not count up")
...
greeting(greeting: "Hi", name: "Dallin")
greeting(greeting: nil, name: "Jim")
