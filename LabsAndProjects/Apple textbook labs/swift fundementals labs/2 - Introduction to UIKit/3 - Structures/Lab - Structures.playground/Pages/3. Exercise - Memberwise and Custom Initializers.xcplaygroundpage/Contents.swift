...
var somePlace = GPS(latidtde: 51.514004, longitude: 0.125336)
print(somePlace.latidtde, somePlace.longitude)
...
var favoriteBook = Book(title: "Book Tile", author: "Some author", pages: 10000, price: 10.99)
...
var laptop1 = Laptop(yearPurchased: 2025)
var laptop2 = Laptop(yearPurchased: 2026)
/*:
...
struct Height{
    ...
    var heightInCentimeteres: Double
    
    init(heightInInches: Double) {
        self.heightInInches = heightInInches
        heightInCentimeteres = heightInInches * 2.54
    }
    init(heightInCentemeters: Double) {
        self.heightInCentimeteres = heightInCentemeters
        heightInInches = heightInCentemeters / 2.54
    }
}
...
print(someonesHeight.heightInCentimeteres)
...
print(myHeight.heightInCentimeteres)
