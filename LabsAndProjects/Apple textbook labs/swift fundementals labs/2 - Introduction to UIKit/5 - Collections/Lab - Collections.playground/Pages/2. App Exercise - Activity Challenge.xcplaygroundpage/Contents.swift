 ...
 */
var walkingChallanges = ["Walk 3 miles a day", "Run 5 times a week"]
var runningChallenges = ["Run 5 miles", "Run a marathon"]
...
} else if currentChallenges.count == 1 {
    print("The challenge yoou have chosen is \(currentChallenges)")
} else {
    print("You have hcosen multiple Challenges.")
}
